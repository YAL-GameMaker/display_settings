...
set extName=display_settings
set dllName=display_settings
set gmlDir14=%solutionDir%display_settings.gmx
set gmlDir22=%solutionDir%display_settings_yy
set gmlDir23=%solutionDir%display_settings_23
